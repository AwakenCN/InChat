...
import com.github.unclecatmyself.common.utils.ssl.SecureSocketSslContextFactory;
...
public abstract class AbstractBootstrapServer implements BootstrapServer {
    ...
    protected  void initHandler(ChannelPipeline channelPipeline, InitNetty serverBean){
        ...
        channelPipeline.addLast(new DefaultAbstractHandler(new AbstractHandlerService(ConfigManager.inChatVerifyService, ConfigManager.asyncDataListener)));
    }
